...
//
    ...
    def getCategory1MaxmonthScore() {
        def cat_1 = new ArrayList()
        def cat1_max = sqlClient.client.rows("select avg(price) as price,avg(effect_ln_baseprice) as effect_ln_baseprice,avg(effect_debut) as effect_debut,avg(effect_discount) as effect_discount,avg(effect_coupon) as effect_coupon from  ods.mars_max_month_avg_cat1 ")
    ...
    def getCategory2MaxmonthScore(String category_1) {
        def cat_2 = new ArrayList()
        def cat2_max = sqlClient.client.rows("select avg(price) as price,avg(effect_ln_baseprice) as effect_ln_baseprice,avg(effect_debut) as effect_debut,avg(effect_discount) as effect_discount,avg(effect_coupon) as effect_coupon from  ods.mars_max_month_avg_cat2  where category_1 = ${category_1}")
    ...
    def getProductMaxmonthScore(String category_1,String category_2) {
        def pro = new ArrayList()
        def pro_max = sqlClient.client.rows("select avg(price) as price,avg(effect_ln_baseprice) as effect_ln_baseprice,avg(effect_debut) as effect_debut,avg(effect_discount) as effect_discount,avg(effect_coupon) as effect_coupon from  ods.mars_max_month_avg_product  where category_1 = ${category_1} and category_2 = ${category_2} ")
    ...
    def getSingleProductMaxmonthScore(String category_1,String category_2,String product_name){
        def pro_single = new ArrayList()
        def pro_max = sqlClient.client.rows("select avg(price) as price,avg(effect_ln_baseprice) as effect_ln_baseprice,avg(effect_debut) as effect_debut,avg(effect_discount) as effect_discount,avg(effect_coupon) as effect_coupon from  ods.mars_max_month_avg_single_product  where category_1 = ${category_1} and category_2 = ${category_2} and product_name = ${product_name} ")
